/* Country dial codes for the phone-field component. ISO 3166-1 alpha-2 + E.164
   calling code; flag emoji is derived at runtime from the ISO code (see
   phoneField.js) so this file stays plain data. Egypt/Gulf/Levant listed
   first since they're this business's primary market. */
window.HP_COUNTRIES = [
  { iso2: 'EG', name: 'Egypt', nameAr: 'مصر', dial: '20' },
  { iso2: 'SA', name: 'Saudi Arabia', nameAr: 'السعودية', dial: '966' },
  { iso2: 'AE', name: 'United Arab Emirates', nameAr: 'الإمارات', dial: '971' },
  { iso2: 'KW', name: 'Kuwait', nameAr: 'الكويت', dial: '965' },
  { iso2: 'QA', name: 'Qatar', nameAr: 'قطر', dial: '974' },
  { iso2: 'BH', name: 'Bahrain', nameAr: 'البحرين', dial: '973' },
  { iso2: 'OM', name: 'Oman', nameAr: 'عُمان', dial: '968' },
  { iso2: 'JO', name: 'Jordan', nameAr: 'الأردن', dial: '962' },
  { iso2: 'LB', name: 'Lebanon', nameAr: 'لبنان', dial: '961' },
  { iso2: 'IQ', name: 'Iraq', nameAr: 'العراق', dial: '964' },
  { iso2: 'LY', name: 'Libya', nameAr: 'ليبيا', dial: '218' },
  { iso2: 'DZ', name: 'Algeria', nameAr: 'الجزائر', dial: '213' },
  { iso2: 'MA', name: 'Morocco', nameAr: 'المغرب', dial: '212' },
  { iso2: 'TN', name: 'Tunisia', nameAr: 'تونس', dial: '216' },
  { iso2: 'SD', name: 'Sudan', nameAr: 'السودان', dial: '249' },
  { iso2: 'SY', name: 'Syria', nameAr: 'سوريا', dial: '963' },
  { iso2: 'YE', name: 'Yemen', nameAr: 'اليمن', dial: '967' },
  { iso2: 'PS', name: 'Palestine', nameAr: 'فلسطين', dial: '970' },
